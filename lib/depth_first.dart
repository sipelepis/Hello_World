...
class depth_first_Page extends StatefulWidget {
  const depth_first_Page({super.key});

  @override
  State<depth_first_Page> createState() => _depth_first_PageState();
}

class _depth_first_PageState extends State<depth_first_Page> {
  List<int> numbers = [];
  String input = '';
